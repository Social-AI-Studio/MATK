...
def main(model_type, image_dir, output_dir, device, num_partitions, partition_idx):
...
if __name__ == "__main__":
    ...
    main(args.model_type, args.image_dir, args.output_dir, args.device, args.num_partitions, args.partition_idx)